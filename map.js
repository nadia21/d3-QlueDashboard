...
d3.json('map1.geojson', function(error, features) {
  ...
  d3.csv('data4ini.csv', function(data) {
...
function hideDetails() {
  ...
  d3.select('#initial').classed("hidden", false);
      ...
      */
      ...
      // the left.
      var left = Math.min(width - 2 * d.name.length, mouse[0] + 0);
      var top = mouse[1] + 25;
